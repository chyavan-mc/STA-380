...
>
> We know that, <br>
>   $P(Y) = P(Y|R_{c}).P(R_{c}) + P(Y|T_{c}).P(T_{c})$
>
> Rearranging, <br>
>   $P(Y|T_{c}) = \frac{ P(Y) - P(Y|R_{c}).P(R_{c}) }{P(T_{c})}$
>
...
>   $P(Y|R_{c}).P(R_{c}) = P(Y \cap R_{c}) = 0.5*0.3 = 0.15$
>
> Substituting in the rearranged equation, <br>
>   $P(Y|T_{c}) = \frac{0.65 - 0.15}{0.7}$ <br>
>   $P(Y|T_{c}) = 0.7143$
>
> Therefore, the fraction of clickers among truthful clickers who clicked yes would be **0.7143**
...
knitr::kable(outliers,
             caption = "Outliers in traffic in the data")
```
