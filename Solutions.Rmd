...
confusionMatrix(as.factor(predicted$pred_author),as.factor(predicted$actual_author))
...
## We wanted improve our model so we tried to fit PCA and run the model again
...
To further improvr upon our accuracy we tried random forest model
```{r}
set.seed(1)
